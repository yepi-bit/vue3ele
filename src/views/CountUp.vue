...
<style>
    ...
    .countup-card-item:hover {
        box-shadow: 0 2px 12px 0 coral;
        transition: all ease 0.3s;
    }
    ...
    .countup-card-item-box:hover i {
        right: 0 !important;
        bottom: 0 !important;
        transition: all ease 0.3s;
    }
    .countup-card-item-box i {
        position: absolute;
        right: -10px;
        bottom: -10px;
        font-size: 70px;
    ...
    .countup-card-item-box .countup-card-item-flex {
        padding: 0 20px;
        color: #ffffff;
    }
    .countup-card-item-box .countup-card-item-flex .countup-card-item-title, .countup-card-item-tip {
        font-size: 13px;
    }
    .countup-card-item-box .countup-card-item-flex .countup-card-item-title-num {
        font-size: 18px;
    }
    .countup-card-item-box .countup-card-item-flex .countup-card-item-tip-num {
        font-size: 13px;
    }
</style>
